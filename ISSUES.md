...
> Generated by `core/hooks/entropy/dashboard/entropy-dashboard.py`, which scans `code/dobra`. Never edit inside this block, and never copy a count out of it — a copied number is the drift these checks exist to catch.

2026-08-31 · 15 tracked files scanned · **14 findings here**

| Check | Findings |
|-------|----------|
| Off-allowlist `.md` types | 2 |
...
- EVAL.md: 'EVAL.md' is not a known .md type.
- IDEAS.md: 'IDEAS.md' is not a known .md type.
...
- CONTEXT.md: retired token '/loops' survives (line 12).
...
- ISSUES.md: cites 'Front 17' (line 81).
...
- code/dobra/IDEAS.md — 9 line(s) over the 120-column cap (first at line 2)
...
- CONTEXT.md: head is 628 tok carrying 2 constraint(s).
...
- code/dobra — 3 merged into main: git -C code/dobra push origin --delete feature/bugs-rename feature/issues-rename feature/routing-row-rebase
